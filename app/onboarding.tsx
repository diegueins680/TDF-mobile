...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingBottom: 20,
    // Native reserves the status-safe offline banner lane. When content grows,
    // the panel starts here and remains reachable through the ScrollView.
    paddingTop: Platform.select({ web: 44, default: 64 }),
  },
  panel: {
    width: '100%',
    maxWidth: 640,
